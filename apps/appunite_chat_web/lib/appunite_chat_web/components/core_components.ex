defmodule AppuniteChatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AppuniteChatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AppuniteChatWeb.Gettext, "errors", msg, opts)
    end
  end
